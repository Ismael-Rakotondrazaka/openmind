<template>
  <template v-if="isActive">
    ...
    <i v-else-if="reactionType === 'love'" class="pi pi-heart-fill"></i>
  ...
  <template v-else>
    ...
    <i v-else-if="reactionType === 'love'" class="pi pi-heart"></i>
...
const props = defineProps<ReactionIconProps>();

const reactionType = computed<ReactionType | undefined>(
  () => props.reaction?.type,
);

const isActive = computed(() => props.reaction !== null);
</script>
