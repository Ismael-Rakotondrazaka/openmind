<template>
  <PrimeAvatarGroup>
    <PrimeAvatar v-if="haveLike" icon="pi pi-thumbs-up-fill" shape="circle" />
    <PrimeAvatar v-if="haveLove" icon="pi pi-heart-fill" shape="circle" />
    <PrimeAvatar v-if="haveCelebrate" shape="circle" class="text-sm">
      <template #icon>
        <svg
          class="pi !text-xl"
