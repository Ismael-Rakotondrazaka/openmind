  ...
  >
    ...
    >
      <g fill="none" fill-rule="evenodd">
        ...
        <path
          fill="currentColor"
          d="m8.076 7.26l.095.083l8.486 8.485a1 1 0 0 1-.246 1.595l-.116.05L5.91 21.3c-1.952.72-3.853-1.115-3.26-3.064l.05-.146L6.526 7.705a1 1 0 0 1 1.447-.516zm-.214 2.602l-3.285 8.92a.5.5 0 0 0 .562.664l.08-.023l8.918-3.286zm9.245 1.742c.911.048 2.16.24 3.246.892a1 1 0 0 1-.925 1.77l-.104-.055c-.682-.41-1.554-.57-2.322-.61a7.666 7.666 0 0 0-.95.004l-.316.031a1 1 0 0 1-.281-1.98a8.587 8.587 0 0 1 1.652-.053m2.025-2.786a1 1 0 0 1 .116 1.993l-.116.007h-.708a1 1 0 0 1-.116-1.993l.116-.007zM15.95 8.05a1 1 0 0 1 .083 1.32l-.083.094l-1.06 1.061a1 1 0 0 1-1.498-1.32l.083-.094l1.06-1.06a1 1 0 0 1 1.415 0m-2.587-5.266c.448 1.346.208 2.82-.072 3.85a10.11 10.11 0 0 1-.69 1.863a1 1 0 0 1-1.79-.893a8.13 8.13 0 0 0 .55-1.496c.227-.832.341-1.735.166-2.475l-.061-.216a1 1 0 1 1 1.897-.633m5.415 2.438a1 1 0 0 1 0 1.414l-.707.707a1 1 0 1 1-1.414-1.414l.707-.707a1 1 0 0 1 1.414 0"
        />
      </g>
    </svg>
    <br /><span class="p-button-label">Celebrate</span>
  </PrimeButton>
</template>

<script lang="ts" setup>
type ReactionCelebrateButtonEmits = {
  "reaction:delete": [];
  "reaction:create": [];
  "reaction:edit": [];
};

const emit = defineEmits<ReactionCelebrateButtonEmits>();

interface ReactionCelebrateButtonProps {
  reaction: Reaction | null;
}

const props = defineProps<ReactionCelebrateButtonProps>();

const onButtonClickHandler = () => {
  if (props.reaction === null) {
    emit("reaction:create");
  } else if (props.reaction.type === "celebrate") {
...
const isActive = computed(
  () => props.reaction !== null && props.reaction.type === "celebrate",
);
